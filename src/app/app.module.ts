...
import { AdditionalDriversTravelsComponent } from './components/additional-drivers/additional-drivers-travels/additional-drivers-travels.component';
@NgModule({
  declarations: [
    // ---------------- [ Angular ] ----------------
    AppComponent,
    ...
    AdditionalDriversTravelsComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
